...
<head>
	...
	<title>HIRE - Employee Profile</title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="../"><img src="../images/01.jpg" alt="Logo" /></a>
						</div>
					</div>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
										...
										<div class="form-group bootstrap3-wysihtml5-wrapper">
										<label>Display CV</label>
										<input accept="PDF/*" type="file" name="PDFF"  required >
										</div>
										...
										?><a onclick = "return confirm('Are you sure you want to delete your CV ?')" class="btn btn-primary btn-inverse" href="app/drop-dp.php">Delete</a> <?php
}
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : settat-PKJ</p>
								<p>Email : <a href="mailto:Hire@gmail.com">Hire@gmail.com</a></p>
								<p>Phone : <a href="tel: +212648029148"> +212648029148</a></p>
