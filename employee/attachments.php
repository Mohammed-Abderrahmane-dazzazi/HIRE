						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="language.php"><i class="fa fa-language"></i> Language</a>
										</li>
										<li>
											<a href="training.php"><i class="fa fa-gears"></i>Skills</a>
										</li>
										<!--<li>
											<a href="referees.php"><i class="fa fa-users"></i> References</a>
										</li>-->
										<li>
											<a href="academic.php"><i class="fa fa-graduation-cap"></i> Academic</a>
										</li>
										<li>
											<a href="experience.php"><i class="fa fa-briefcase"></i>Experience</a>
										</li>
										<li class="active">
											<a href="attachments.php"><i class="fa fa-folder-open"></i> Other(Loisir)</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
								    ...
								    <input class="form-control" value="<?php echo "$att_title"; ?>" placeholder="Eg: reading, driving licence" type="text" name="title" required> 
							        </div>
								    ...
								    <input class="form-control" value="<?php echo "$att_issuer"; ?>" placeholder="Enter your degree of commitement" type="text" name="issuer" required> 
							        </div>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Add Attachments(Loisir)</h4>
				                    </div>
							        ...
							        <div class="form-group"> 
								    <label>Attachment Type</label>
								    <input class="form-control" placeholder="Eg: reading, driving licence" type="text" name="title" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>commitment</label>
								    <input class="form-control" placeholder="Enter degree of commitement" type="text" name="issuer" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>Select Attachment (if you have it)</label>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About HIRE</h5>
											<p>HIRE is a job portal, online job management system developed by CA3 for his project in Mars 2023.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										<h5 class="footer-title">Rapide Links</h5>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">HIRE Contact</h5>
								
								<p>Address : Settat-PJK</p>
								<p>Email : <a href="mailto:HIRE@gmail.com">HIRE@gmail.com</a></p>
								<p>Phone : <a href="tel:+212648029148">+233 546 607 474</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> HIRE Vision Software</p>
