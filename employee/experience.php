						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<b style="color:#990000">All fields with * are mandatory (obligatoire)</b>
							        ...
							        <div class="form-group"> 
								    <label>Supervisor Name (Encadrent)</label>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Experience</h4>
				                    </div>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>HIRE Jobs is a recruiting portal, online recruiting management system developed by CA3 for his project in Mars 2023.</p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by HIRE.COM</a></li>
								</ul>
