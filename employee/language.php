							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="attachments.php"><i class="fa fa-folder-open"></i> Other (Loisirs)</a>
										</li>
										<li>
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
									                    ...
									                    <option <?php if ($row ['speak'] == "Fair") { print ' selected '; } ?> value="Fair">AVERAGE</option>
									                    ...
									                    <option <?php if ($row ['reading'] == "Fair") { print ' selected '; } ?> value="Fair">AVERAGE</option>
									                    ...
									                    <option <?php if ($row ['writing'] == "Fair") { print ' selected '; } ?> value="Fair">AVERAGE</option>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>HIRE Jobs is a job portal, online job management system developed by CA3 in Mars 2023.</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> HIRE Vision Soft</p>
