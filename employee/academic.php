...
<head>
	...
	<title>HIRE - Academic Qualifications</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<!--<li  >
											<a href="qualifications.php"><i class="fa fa-trophy"></i> Professional</a>
										</li>-->
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								?>
                                    ...
                                    <option value="Degree">Degree(DEUST)</option>
                                    <option value="Diploma">Diploma(LST)</option>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>HIRE is a job portal, online job management system developed by HIRE for his project in Mars 2023.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="HiRE@gmail.com">HIRE@gmail.com</a></p>
