					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Settat<br/> PKJ <br/>FSTS</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:HIRE@gmail.com">HIRE@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+212648029148">+212648029148</a>
								</li>
